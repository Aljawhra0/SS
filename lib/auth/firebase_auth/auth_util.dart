...
DocumentReference? get currentUserReference =>
    loggedIn ? UesrsinfoRecord.collection.doc(currentUser!.uid) : null;

UesrsinfoRecord? currentUserDocument;
final authenticatedUserStream = FirebaseAuth.instance
    ...
    .switchMap(
      (uid) => uid.isEmpty
          ? Stream.value(null)
          : UesrsinfoRecord.getDocument(UesrsinfoRecord.collection.doc(uid))
              .handleError((_) {}),
    )
